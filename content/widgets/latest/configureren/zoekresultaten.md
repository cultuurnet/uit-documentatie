...
Via zoekresultaten stel je een lijst van (gevonden) activiteiten samen. In dit blok bepaal je welke evenementen je agenda toont, en welke informatie (locatie, tijdstip, prijs, etc.) je van de evenementen wilt tonen.
Dit blok bevat ook de instellingen voor een detailpagina van een activiteit.
...
| -- | -- | -- | -- |
| Je selecteerde | Bepaal de naam van je zoekresultaten-pagina. Dit is enkel relevant indien je van plan bent een widget te maken met meerdere zoekboxen en/of zoekresultaten. | Tekst | ```Zoekresultaten-1``` |
...
| Setting | Beschrijving | Waarde | Voorbeeld | 
| -- | -- | -- | -- |
| Huidige zoekopdracht tonen | Bepaal of de zoekopdracht uit de zoekbox getoond mag worden of niet | [x] / [ ] | ```[x] Huidige zoekopdracht tonen``` |
| Verbergfilters | Bepaal of een surfer langlopend of permanent aanbod kan verbergen | [x] / [ ] |  ```[x] Langlopend aanbod``` |
| Labels altijd weergeven als iconen | Bepaal of detaillabels (zoals 'wat', 'waar', 'prijs', etc) voluitgeschreven getoond worden of als iconen | [x] / [ ] | ```[x] Labels altijd weergeven als iconen``` |
| Weergave van evenementen | Bepaal hoe evenementen weergegeven worden: in een lijst (verticaal onder elkaar), of in een tegelvorm weergegeven moeten worden. Om een overzichtelijke en logische weergave te verzekeren, raden we aan om bij het aantal resultaten per pagina bij tegelweergave een veelvoud van 3 te nemen. | (x) / ( ) | ```(x) Lijstweergave``` |
| Aantal resultaten per pagina | Bepaal hoeveel evenementen er per pagina weergegeven worden. Er geldt geen minimum- of maximumlimiet. | Getal | ```10``` |
...
| Thema | Bepaal of per evenement het thema (bv. pop en rock) getoond mag worden | [x] / [ ] | ```[x] Thema``` |
...
| Aantal karakters | Bepaal hoeveel karakters van de beschrijving getoond mag worden | Getal | ```200``` |
| Toon UiT-tip badge | Bepaal of een badge getoond mag worden bij evenementen die getipt worden in de media | [x] / [ ] | ```[x] Toon UiT-tip badge``` |
| Toon enkel UiT-tip badge van een specifieke curator | Bepaal van welke mediakanalen de UiT-tip badge getoond mag worden | [x] / [ ] | ```[x] BRUZZ``` |
| Prijsinformatie | Bepaal of de prijsinformatie (basisprijs, UiTPAS-kansentarief en eventuele andere tarieven getoon mag worden | [x] / [ ] | [x] Prijs |
| Reserveringen | Bepaal of een ticketlink ('Koop tickets') of reservatielink ('Reserveer plaatsen') getoond mag worden | [x] / [ ] | ```[x] Reserveringen``` |
